...
|27/05/2018|2.2|Formatando tabelas com colunas "Eu, como.." e "Para que..."|Gustavo Carvalho|
...
|Tipo|História|Eu, como...|Para que...|Critérios de Aceitação|Pontuação|Prioridade|
|----|----|---------|-------|-----|------|--|
...
|Tipo|História|Eu, como...|Para que...|Critérios de Aceitação|Prioridade|
|----|----|---------|---|-----|---|
...
|RF|US09|Eu, como usuário, gostaria de acessar os chats. | Para poder participar das discussões.|Alguns chats devem ter limitações para não seguidores.|Baixa|
