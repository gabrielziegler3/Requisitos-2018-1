...
* i(p2): usuário assiste [stream](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Stream)
* i(p3): usuário pode dar [follow](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Follower) [subscribe](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Subscribe)
* i(p4): usuário receber notificações de conteúdo
* i(p5): usuário não se cadastra
* i(p6): usuário pode acompanhar [chat](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Group-Chat)
...
* i(p3): Pouco diferencial de ​ subscribers ​ para ​ [followers](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Follower)
* i(p4): Estimula os ​[Streamers](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Streamer) a produzir mais conteúdos exclusivos e
...
* i(p1): O [Twitch](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Twitch) pode oferecer uma receita mensal para pessoas que gostam de jogar e têm
disponibilidade.
* i(p2): Para ganhar uma boa receita, o Twitch partner com muitas frequência e estar sempre
jogando, diariamente.
* i(p3): Ganhar dinheiro com [Twitch](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Twitch) é muito difícil, pois o usuário deve usar a maior parte do
...
* i(p4): Caso o usuário goste muito de assistir [streams](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Stream), é uma alternativa bem mais prática, que fará o mesmo, acessar de forma mais constante a plataforma.
* i(p5): O Usuário de Add-ons que são muitíssimos, estes que anteriormente utilizavam a plataforma apenas para isto (World of Warcraft add-ons), podem passar a assistir [streams](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Stream) por impulso, devido à disponibilização integrada da plataforma.
* i(p6): Se o usuário não possui interesse em add-ons e o serviço de chat da [Twitch](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Twitch), não existem nenhum diferenciais indispensáveis que o levem a baixar a plataforma.
...
* P2: Entretanto, como uma grande parte do público frequentador da [Twitch](https://github.com/gabrielziegler3/Requisitos-2018-1/wiki/Twitch) vê vantagem nos serviços extra-stream que a plataforma oferece, assim como a praticidade pra quem vê exclusivamente streaming no app, o Aplicativo de Desktop continua sendo uma opção favorável e viável.
